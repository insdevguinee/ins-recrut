...
<div class="right_box">                  
    ...
    <div class="table_box">
    <!-- <a href="<?= site_url('postulants/export') ?>" class="btn btn-success">Telecharger la liste</a>
    <a href="<?= site_url('download') ?>" class="btn btn-success">Telecharger les images</a> -->

    <table id="tablo_recrut" class="table table-striped table-bordered" style="width:100%">
        <thead>
            <tr>
                <th>Matricule</th>
                <th>Nom</th>
