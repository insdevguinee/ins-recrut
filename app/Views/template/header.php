...
<div id="windows">
    ...
    <div id="header_new">
        <div class="container" style="">
            ...
            <div class="header_content">
                <div style=" ">
				  <span class="taille-republique">
					  REPUBLIQUE DE GUINEE
				  </span>
                </div>
                <div style="padding-top:0px; ">
				  <span class="taille-devise">
    ...
    <div id="header_new_2">
        ...
        <div style="margin-top:0px; display: none"><span>Nous faire recenser, c'est construire notre avenir</span></div>
    </div>
    <div id="contener" class="idBack">
        ...
        <div class="container">
			...
			<div style="padding-top:0px; text-align: center; font-weight: bold; font-size:18px"> INSTITUT NATIONAL DE LA STATISTIQUE (INS) </div>
            <br>
            ...
            <div class="titleDrh" style="font-style: italic;font-size:16px; display: none"><span class="text-primary">Nous faire recenser, c'est construire notre avenir </span></div>
