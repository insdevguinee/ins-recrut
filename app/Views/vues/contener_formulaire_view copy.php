...
<div class="rigthContener">
    <?php if(isset($projet)):?>
        ...
        <div id="wizard">
			...
			?>
            <!--<form id="multiphase" action="<?php echo base_url().'register'?>" method="post" enctype="multipart/form-data"
                  class="form-horizontal form_recrut">-->
                <div>
                    <h2>AVIS RECRUTEMENT</h2>
                    <section>
                        <?php
                        $this->include('vues/contener_contrat_view.php');
                        ?>
                    </section>
                    <h2>CONDITIONS GENERALES</h2>
                    <section>
                        <?php
                        $this->include('vues/contener_condition_generale_view.php');
                        ?>
                    </section>
					<h2>CODE DE BONNE CONDUITE</h2>
                    <section>
                        <?php
                        $this->include('vues/contener_bonneconduite_view.php');
                        ?>
                    </section>
                    ...
                    <section>
                        <?php
                        $this->include('vues/recrutement_view.php');
                        ?>
                    </section>
                    ...
                    <section>
                        <?php
                        $this->include('vues/contener_declaration_honneur_view.php');
                        ?>
                    </section>
                     <h2>RECAPITULATIF</h2>
                    <section>
                        <?php
                        $this->include('vues/contener_recapitulatif_view.php');
                        ?>
                    </section>
        ...
        <div id="wizard_small_screen">
            <!--<form id="multiphase_small" action="<?php echo base_url().'register'?>" method="post" enctype="multipart/form-data"
                  class="form-horizontal form_recrut_small">-->
			<?php 
			...
			?>
                <div>
                    ...
                    <section>
                        <?php
                        $this->include('vues/contener_contrat_small_view.php');
                        ?>
                    </section>
                    <h2>CONDITIONS GENERALES</h2>
                    <section>
                        <?php
                        $this->include('vues/contener_condition_generale_small_view.php');
                        ?>
                    </section>
                    <h2>CODE DE BONNE CONDUITE</h2>
                    <section>
                        <?php
                        $this->include('vues/contener_bonneconduite_small_view.php');
                        ?>
                    </section>
                    ...
                    <section>
                        <?php
                        $this->include('vues/recrutement_small_view.php');
                        ?>
                    </section>
                    <h2>DECLARATION SUR L'HONNEUR</h2>
                    <section>
                        <?php
                        $this->include('vues/contener_declaration_honneur_small_view.php');
                        ?>
                    </section>
                     <h2>AVIS RECRUTEMENT</h2>
                    <section>
                        <?php
                        $this->include('vues/contener_recapitulatif_small_view.php');
                        ?>
                    </section>
                </div>
            <!--</form>-->
...
<div class="blink form-group top-30" style="text-align:center;color:red;font-weight: bold; text-decoration: blink">
   ...
   <!--
    <h4 style="font-family:arial; color:black;">Nos Partenaires</h4>
    <div><img src="<?php echo 'assets/images/SansImgs.png'?>"></div>
    -->
    <?php else: ?>
            ...
            onFinishing: function (event, currentIndex)
            {
                ...
                //if($(this).is(':checked')){
                    ...
                    $.post("recrutement.php",
                            ...
                            function(data){
                               if(data == "ok"){
                                  $('form.form_recrut').find('section#steps-uid-0-p-1 select[name=departement]').val("0");
                                
                                  $.alert({
                                    title: 'INFORMATION',
                                    content: "Désolé, veuillez changer votre lieu d'affectation, il n'existe plus de place daisponible dans ette partie du pays",
                                        buttons: {
                                            OK: function(){
                                                //$(location).attr('href','http://localhost:8888/recrutement.rp2023.gn/');
                                                //actualisation du selecteur
